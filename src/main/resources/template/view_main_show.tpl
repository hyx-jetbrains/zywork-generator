        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <{zywork.beanName}TableShow ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import {zywork.beanName}TableShow from './{zywork.beanName}TableShow.vue'
    ...
    export default {
        name: '{zywork.beanName}MainShow',
        components: {
            {zywork.beanName}TableShow,
