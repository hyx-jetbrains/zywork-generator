        ...
        <Row>
            <i-col span="24">
                <Card>
                    ...
                    <{zywork.beanName}TableSingle ref="table" v-on:searchTable="searchTable" v-on:showDetailModal="showDetailModal"/>
                </Card>
            </i-col>
        </Row>
...
<script>
    ...
    import {zywork.beanName}TableSingle from './{zywork.beanName}TableSingle.vue'
